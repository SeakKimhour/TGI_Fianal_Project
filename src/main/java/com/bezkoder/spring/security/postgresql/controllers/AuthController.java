...
import com.bezkoder.spring.security.postgresql.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(
				...
				encoder.encode(signUpRequest.getPassword()), null, "normal");
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.ROLE_USER)
					.orElseThrow(() -> new RuntimeException("Error: Role is not ssss."));
			roles.add(userRole);
		} else {
